...
export interface Shipment {
  ...
  vehicleType: string;
  status: 'draft' | 'searching' | 'assigned' | 'pickup' | 'en_route' | 'delivered' | 'disputed';
  pricingMode: 'bidding' | 'instant';
  ...
  paymentStatus?: 'pending' | 'authorized' | 'released' | 'refunded';
...
export interface WalletTransaction {
  id: string;
  type: 'payment' | 'refund' | 'withdrawal' | 'earning' | 'commission';
  amount: number;
  description: string;
  descriptionAr: string;
  date: string;
...
export interface Notification {
  ...
  title: string;
  body: string;
  type: 'shipment' | 'payment' | 'system' | 'bid';
  read: boolean;
  timestamp: string;
  shipmentId?: string;
}
...
export const TEST_USERS: Record<string, { phone: string; otp: string; user: AppUser }> = {
  customer: {
    ...
    user: {
      ...
      role: 'customer',
      type: 'business',
      company: 'مؤسسة المطيري للتجارة',
      companyEn: 'Al-Mutairi Trading Est.',
      rating: 4.8,
      totalShipments: 47,
      walletBalance: 12450,
      verified: true,
  ...
  broker: {
    ...
    user: {
      id: 'user-003',
      name: 'سعود العمري',
      nameEn: 'Saud Al-Omari',
      phone: '+966 55 555 1234',
      email: 'broker@test.com',
      role: 'broker',
      type: 'business',
      company: 'شركة العمري للنقل',
      companyEn: 'Al-Omari Transport Co.',
      rating: 4.7,
      totalShipments: 312,
      walletBalance: 45200,
      verified: true,
...
export const mockShipments: Shipment[] = [
  {
    ...
    customerId: 'user-001',
    pickupCity: 'الرياض',
    pickupAddress: 'حي العليا، طريق الملك فهد',
    deliveryCity: 'جدة',
    deliveryAddress: 'حي الحمراء، شارع التحلية',
    cargoCategory: 'electronics',
    cargoCategoryAr: 'إلكترونيات',
    weight: 2500,
    description: 'Server racks and networking equipment',
    descriptionAr: 'خوادم ومعدات شبكات',
    ...
    driverNameAr: 'فهد القحطاني',
    driverRating: 4.9,
    driverPhone: '+966 50 111 2222',
    driverId: 'user-002',
    vehiclePlate: 'ب ع ن ٢٣٤٥',
    bidsCount: 5,
    distance: 950,
    estimatedDuration: '١٠ ساعات',
    trackingProgress: 0.65,
  ...
  },
  {
    ...
    customerId: 'user-001',
    pickupCity: 'الدمام',
    pickupAddress: 'المنطقة الصناعية الثانية',
    deliveryCity: 'الرياض',
    deliveryAddress: 'حي السلي، المستودعات',
    cargoCategory: 'construction',
    cargoCategoryAr: 'مواد بناء',
    weight: 8000,
    description: 'Steel beams and construction materials',
    descriptionAr: 'حديد وأعمدة ومواد بناء',
  ...
  },
  {
    ...
    customerId: 'user-001',
    pickupCity: 'جدة',
    pickupAddress: 'ميناء جدة الإسلامي',
    deliveryCity: 'المدينة المنورة',
    deliveryAddress: 'المنطقة الصناعية',
    cargoCategory: 'food',
    cargoCategoryAr: 'مواد غذائية',
    weight: 5000,
    description: 'Frozen food shipment',
    descriptionAr: 'شحنة مواد غذائية مجمدة',
    ...
    pickupDate: '2024-12-16',
    driverName: 'Turki Al-Zahrani',
    driverNameAr: 'تركي الزهراني',
    driverRating: 4.8,
    driverPhone: '+966 50 777 8888',
    driverId: 'd-007',
    vehiclePlate: 'ح خ د ٥٦٧٨',
    bidsCount: 7,
    distance: 420,
    estimatedDuration: '٤.٥ ساعات',
    paymentStatus: 'authorized',
  ...
  },
  {
    ...
    customerId: 'user-001',
    pickupCity: 'الرياض',
    pickupAddress: 'حي النخيل، شارع الأمير تركي',
    deliveryCity: 'الخبر',
    deliveryAddress: 'حي الراكة، شارع الأمير سلطان',
    cargoCategory: 'furniture',
    cargoCategoryAr: 'أثاث',
    weight: 1200,
    description: 'Office furniture set',
    descriptionAr: 'طقم أثاث مكتبي',
    specialHandling: ['fragile'],
    vehicleType: 'van',
    status: 'delivered',
    pricingMode: 'bidding',
    ...
    driverName: 'Khalid Al-Shehri',
    driverNameAr: 'خالد الشهري',
    driverRating: 4.8,
    driverPhone: '+966 50 333 4444',
    driverId: 'd-003',
    vehiclePlate: 'ك م ل ٨٩٠١',
    bidsCount: 4,
    distance: 380,
    estimatedDuration: '٤ ساعات',
  ...
  },
  {
    ...
    customerId: 'user-001',
    pickupCity: 'الطائف',
    pickupAddress: 'سوق الخضار المركزي',
    deliveryCity: 'مكة المكرمة',
    deliveryAddress: 'حي العزيزية',
    cargoCategory: 'food',
    cargoCategoryAr: 'مواد غذائية',
    weight: 3000,
    ...
    driverNameAr: 'سلطان العتيبي',
    driverRating: 4.6,
    driverPhone: '+966 50 444 5555',
    driverId: 'd-004',
    vehiclePlate: 'ع ر ب ٣٤٥٦',
    bidsCount: 2,
    distance: 88,
    estimatedDuration: '١.٥ ساعة',
    paymentStatus: 'released',
  ...
  },
  {
    ...
    customerId: 'user-003',
    pickupCity: 'الجبيل',
    pickupAddress: 'المنطقة الصناعية',
    deliveryCity: 'الدمام',
    deliveryAddress: 'ميناء الملك عبدالعزيز',
    cargoCategory: 'industrial',
    cargoCategoryAr: 'صناعي',
    weight: 12000,
    description: 'Industrial machinery parts',
    descriptionAr: 'قطع آلات صناعية',
    specialHandling: ['oversized', 'hazardous'],
    vehicleType: 'flatbed',
    status: 'pickup',
    pricingMode: 'bidding',
    estimatedPrice: 3500,
    ...
    createdAt: '2024-12-15',
    pickupDate: '2024-12-16',
    driverName: 'Saad Al-Harbi',
    driverNameAr: 'سعد الحربي',
    driverRating: 4.9,
    driverPhone: '+966 50 555 6666',
    driverId: 'd-005',
    vehiclePlate: 'ق ص د ٧٨٩٠',
    bidsCount: 6,
    distance: 95,
    estimatedDuration: '١.٥ ساعة',
    paymentStatus: 'authorized',
  ...
  },
  {
    ...
    customerId: 'user-001',
    pickupCity: 'تبوك',
    pickupAddress: 'المنطقة الزراعية',
    deliveryCity: 'الرياض',
    deliveryAddress: 'سوق العزيزية المركزي',
    cargoCategory: 'food',
    cargoCategoryAr: 'مواد غذائية',
    weight: 7000,
    description: 'Fresh dates',
    descriptionAr: 'تمور طازجة - جودة ممتازة',
    specialHandling: [],
    vehicleType: 'lorry',
    status: 'searching',
    pricingMode: 'bidding',
...
export const mockBids: Bid[] = [
  {
    ...
    amount: 1650,
    estimatedArrival: '٥ ساعات',
    message: 'I can load immediately',
    messageAr: 'أقدر أحمّل فوراً، عندي خبرة بمواد البناء',
  ...
  },
  {
    ...
    amount: 1500,
    estimatedArrival: '٦ ساعات',
    message: 'Best price guaranteed',
    messageAr: 'أفضل سعر مضمون، السطحة جاهزة',
    createdAt: '2024-12-16T10:45:00',
  },
  {
    id: 'bid-003',
    shipmentId: 'SH-2024-002',
    ...
    amount: 1700,
    estimatedArrival: '٤ ساعات',
    message: 'Express delivery',
    messageAr: 'توصيل سريع، تعامل ممتاز',
  ...
  },
  {
    ...
    amount: 2900,
    estimatedArrival: '١٢ ساعة',
    message: 'Available for long haul',
    messageAr: 'متاح للمسافات الطويلة، شاحنة صيانة ممتازة',
