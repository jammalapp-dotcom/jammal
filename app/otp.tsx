        ...
        <View style={styles.content}>
          ...
          <Animated.View entering={FadeInDown.delay(100).duration(500)} style={styles.headerSection}>
            <View style={styles.iconCircle}>
              <MaterialIcons name="sms" size={36} color={theme.accent} />
            </View>
          ...
          <Animated.View entering={FadeInDown.delay(300).duration(500)} style={styles.timerSection}>
            {otpTimer > 0 ? (
              <Text style={styles.timerText}>إعادة الإرسال بعد {otpTimer} ثانية</Text>
            ) : (
          ...
          <View style={styles.hintCard}>
            ...
            <Text style={styles.hintText}>أدخل رمز التحقق المكون من ٦ أرقام المرسل إلى جوالك</Text>
          </View>
        </View>
