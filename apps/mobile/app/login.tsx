                ...
                <ScrollView contentContainerStyle={styles.scroll} showsVerticalScrollIndicator={false} keyboardShouldPersistTaps="handled">
                    ...
                    <Animated.View entering={FadeInDown.delay(300).duration(600)} style={styles.inputCard}>
                        ...
                        <View style={styles.phoneRow}>
                            ...
                            <TextInput style={styles.phoneInput} placeholder="05X XXX XXXX" placeholderTextColor={theme.textTertiary} value={phone} onChangeText={setPhone} keyboardType="phone-pad" maxLength={15} textAlign="right" />
                        </View>
                        <Pressable style={[styles.sendBtn, (!phone || loading) && styles.sendBtnDisabled]} onPress={handleSendOtp} disabled={!phone || loading}>
