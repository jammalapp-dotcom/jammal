-- ====================================================================
-- جمّال - Jammal App | Supabase Database Schema
-- ====================================================================
-- هذا الملف هو المصدر الوحيد للحقيقة لهيكل قاعدة البيانات
-- أي تغيير يجب أن يتم هنا أولاً ثم يُطبّق عبر Supabase CLI
-- ====================================================================
...
-- ====================================================================
-- 1. جدول المستخدمين (يرتبط بـ Supabase Auth)
-- يدعم 4 أدوار: عميل، سائق، وسيط، مدير
-- ====================================================================
...
-- ====================================================================
-- 2. جدول الشحنات
-- يتتبع دورة حياة الشحنة من الإنشاء إلى التوصيل
-- ====================================================================
create table public.shipments (
  id uuid default uuid_generate_v4() primary key,
  short_id text unique not null, -- مثلاً: SH-2024-001
...
-- ====================================================================
-- 3. جدول المزايدات (عروض الأسعار من السائقين)
-- ====================================================================
...
-- ====================================================================
-- 4. جدول الرسائل (الدردشة المرتبطة بالشحنات)
-- ====================================================================
...
-- ====================================================================
-- 5. تفعيل Realtime على الجداول المطلوبة
-- ====================================================================
-- لتفعيل البث الحي للرسائل والشحنات والمواقع
